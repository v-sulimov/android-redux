 ...
 *
 * ### Type Parameters
 * @param S The type of the state managed by this reducer (e.g., a data class representing app state).
 *
 * ### Best Practices
 ...
 * @param S The type of the state (e.g., `CounterState`).
 *
 * ### Best Practices
 ...
 */
abstract class TypedReducer<A : Action, S>(
    ...
    final override fun reduce(action: Action, state: S): S {
        return if (actionClass.isInstance(action)) {
